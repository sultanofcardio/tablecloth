...
<div id="app">
  <div id="toolbar">
    <button id="tb-run" class="tbtn" data-tip="Run statement at the caret (⌘⏎)">
    ...
    <button id="tb-runscript" class="tbtn" data-tip="Run the whole console">
    ...
    <button id="tb-explain" class="tbtn" data-tip="Explain Plan / Explain Analyse for the statement at the caret">
    ...
    <button id="tb-stop" class="tbtn stop" data-tip="Cancel running statement (⌘F2)" disabled>
      <svg viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="6" width="12" height="12" rx="1.5"/></svg>
    </button>
    <span class="sep"></span>
    <button id="tb-history" class="tbtn" data-tip="Query history">
    ...
    <button id="tb-settings" class="tbtn" data-tip="Data source properties">
    ...
    <button id="tb-commit" class="tbtn" data-tip="Commit transaction" hidden>
    ...
    <button id="tb-rollback" class="tbtn" data-tip="Roll back transaction" hidden>
