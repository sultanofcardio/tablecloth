...
- `roadmap.html` and `changelog.html` are generated (see `_tools/README.md`); `assets/css/roadmap.css` and `assets/js/site.js` carry the roadmap's styles and interactions.
