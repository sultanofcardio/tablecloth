...
<span class="keys"><kbd>⌘</kbd><kbd>⇧</kbd><kbd>O</kbd></span> (<span class="keys"><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>O</kbd></span>) opens a quick pick over every introspected source: tables, columns, routines and the rest. Picking one reveals it in the tree and opens the table or its DDL. The binding is active while the explorer, the Tablecloth panel, a console or a data editor has focus, so it doesn't fight the editor's own <span class="keys"><kbd>⌘</kbd><kbd>⇧</kbd><kbd>O</kbd></span> elsewhere.
